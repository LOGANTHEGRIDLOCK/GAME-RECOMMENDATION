      ...
      <div className="card-bottom">
        ...
        <div className="block-wrap">
          <div className="details-group">
            ...
            <p className="details-item-name fw-6">Released Date: &nbsp;</p>
            <p className="details-item-name fw-6">{gameData?.released}</p>
            </div>
            <div className="details-item d-flex align-items-center">
            <p className="details-item-name fw-6">Updated Date: &nbsp;</p>
            <p className="details-item-value">{gameData?.updated}</p>
            </div>
          </div>
          <Link to = {`/games/${gameData?.id}`} 
          className="card-button text-uppercase mt-3">see more</Link>
        </div>
      </div>
    </GenreItemWrapper>
  );
