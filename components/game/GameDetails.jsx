...
import { AiFillClockCircle, AiOutlineDesktop, AiFillSetting, AiFillTags
 } from "react-icons/ai"
...
const GameDetails = ({ gameData }) => {
  ...
  return (
    ...
    <div className="details-grid d-grid">
      ...
      <ul className="details-list-group">
        ...
        <li className="list-group-item text-white d-flex align-items-center flex-wrap">
          ...
          <span className="item-right item-value fw-6">{ gameData?.released}</span>
        </li>
        ...
        <li className="list-group-item text-white d-flex align-items-center flex-wrap">
          <div className="item-left d-flex align-items-center">
            ...
            <span className="item-title text-uppercase fw-6">platform:</span>
          </div>
          <span className="item-right item-value fw-6">{ platforms?.join(", ")}</span>
        </li>
        ...
        <li className="list-group-item text-white d-flex align-items-center flex-wrap">
          ...
          <span className="item-right item-value fw-6">{ developers?.join(", ")}</span>
        </li>
        ...
        <li className="list-group-item text-white d-flex align-items-center flex-wrap">
          ...
          <span className="item-right item-value fw-6">{ genres?.join(", ")}</span>
        </li>
        ...
        <li className="list-group-item text-white d-flex align-items-center flex-wrap">
          ...
          <span className="item-right item-value fw-6">{ publishers?.join(", ")}</span>
        </li>
      </ul>
      </div>
    ...
    <Tabs>
        ...
        <TabPanel>
        <h3 className='text-white mb-3'>Game Platform</h3>
        ...
        <TabPanel>
          <h3 className="text-white mb-3">Avaliable Stores</h3>
          <div className="card-list">
            {
              gameData?.stores?.map(item => (<StoreItem key={ item?.store?.id}
