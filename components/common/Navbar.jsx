...
import {  BsSteam, BsTwitch, BsYoutube, BsRssFill } from 'react-icons/bs';
      ...
      <div className="navbar-content">
        ...
        <div className="brand-and-toggler d-flex align-items-center justify-content-between">
          ...
          <Link to = "/" className='navbar-brand text-white text-uppercase no-wrap' >
            After <BsLightningFill size = { 25 } color='#FFD700' className='fast'/> <span>Shock</span> </Link>
        ...
        <div className = {`navbar-collapse ${ sidebarStatus ? 'show' : ''}`}>
          ...
          <ul className="navbar-nav"> 
           ...
           <ul className='connect-list d-flex justify-content-center align-items-center mt-5 flex wrap'>
              ...
              <li className="connect-item">
                <Link to = 'https://m.twitch.tv' className='connect-link'>
                  <BsTwitch />
                </Link>
              </li>

              <li className="connect-item">
                <Link to = 'https://www.youtube.com/results?search_query=games' className='connect-link'>
                  <BsYoutube />
                </Link>
              </li>
           </ul>
