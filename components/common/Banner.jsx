...
const Banner = () => {
  return (
    <BannerWrapper className='d-flex align-items-center ' style = {{
      background: `
    ...
    <div className='banner-content w-100 container text-white'>
       ...
       <p className="lead-text">live gaming with lots of other games. Lorem ipsum, dolor sit amet consectetur adipisicing elit. 
       Sunt inventore, ipsa accusantium illo earum explicabo eveniet nihil culpa totam, 
       aliquam cupiditate laboriosam vitae, rerum perferendis omnis beatae a. Velit, dolor.</p>
        <Link to = 'https://www.crazygames.com'>
...
const BannerWrapper = styled.div`
    ...
    .banner-badge:hover{
      background-color: var(--clr-yellow-normal);
      transition: 0.45s;
    }
