    ...
    <FooterWrapper>
       <div className="footer-top">
        <div className="footer-content text-white d-grid container">
          <div className="footer-item">
            <a href="#" className='navbar-brand text-white text-uppercase no-wrap d-block'>After <BsLightningFill size = { 25 } color='#FFD700' className='fast'/> <span> shock</span></a>
            <p className="para-text">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem culpa tempore aspernatur 
              distinctio unde quam adipisci non suscipit maxime at corrupti dicta necessitatibus incidunt assumenda ullam, 
              excepturi amet recusandae sapiente.
            </p>
          </div>

          <div className="footer-item">
            <h5 className="footer-tem-title text-uppercase">quick links</h5>
          ...
          <div className="footer-item">
            <h5 className="footer-tem-title text-uppercase">Supports</h5>
            <ul className="footer-item-links">
          ...
          <div className="footer-item">
            <h5 className="footer-tem-title text-uppercase">newsletter</h5>
       ...
       <div className="footer-bottom">
        <div className="container d-flex flex-column text-center">
          <p className="footer-bottom-text text-green">Copyright &copy; 2023 LoganTheCreator - All rights reserved</p>
